                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarsExample07">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?= URL ?>boutique.php">Shop</a>
                            </li>
                            ...
                            <?php if(adminConnect()): // liens accordé à l'administrateur du site, statut 'admin' dans la BDD donc dans la session ?>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <li><a class="dropdown-item" href="<?= URL ?>admin/gestion_boutique.php">Manage shop</a></li>
                                    <li><a class="dropdown-item" href="<?= URL ?>admin/gestion_user.php">Manage users</a></li>
                                    <li><a class="dropdown-item" href="<?= URL ?>admin/gestion_commande.php">Manage commandes</a></li>
                                    </ul>
                                </li>
                        ...
                        <?php if(connect()): ?>
                            ...
                            <span clas ="d-flex flex-column justify-content-center align-items-center">

                            <span class="fst-italic text-white mb-2">Bonjour <span class="text-warning"><?= $_SESSION['user']['pseudo']; ?></span> !</span>
